...
class ProjectsBillingAccountDetails extends Component {
  render() {
            ...
            {contacts.map((contact, index) => (
              <div className="col-6 col-sm-6">
                <div
                  ...
                  className={`row mx-0 align-items-center user-info-div-main opportunity-info-div-main mb-2 ${contact.default_customer_recipient ? "active" : ""}`}
                >
                  <div className="col-12">
                    ...
                    <div className="user-info-div">
                      ...
                      <p className="mb-0">
                        ...
                        {contact.contact?.default_email && `${contact.contact.default_email?.email},`}{" "}{contact.contact?.default_phone?.phone_number}
                      </p>
...
export default ProjectsBillingAccountDetails;