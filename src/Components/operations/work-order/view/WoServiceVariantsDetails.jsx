...
class WOServiceVariantsDetails extends Component {
    state = {
    ...
    //   if (e === "delete_row") {
    //     let rows = [...this.state.rows].drawer((r) => r.id !== item.id);
    //     this.setState({ rows });
    //   } else {
    ...
    //   this.setState({ qty: this.props.newPricing.proposal_qty || 1 });
    ...
    // handlePricingUom = () => {
    //   const newArr = [];
    //   const { variant } = this.props.newPricing;
    //   if(variant?.daily_price || variant?.hourly_price || variant?.pricing_uom) {
    //   if (variant?.daily_price) {
    //     const obj = {
    //       label: 'Day (d)',
    //       value: 'DAY'
    //     }
    ...
    //     newArr.push(obj)
    //   }
    //   if (variant?.pricing_uom && variant?.price) {
    //     const obj = {
    //       label: variant.pricing_uom?.name,
    //       value: 'UOM',
    //       symbol: `(${variant?.pricing_uom?.symbol})`
    //     }
    //     newArr.push(obj)
    //   }
    // } else {
    ...
    render() {
        ...
        // const foundUom = allOptions?.find((i) => i.id === newPricing.pricing_uom);
        ...
        return (<React.Fragment>
            <div className="col-12 custom-table-body p-0">
                ...
                >
                        ...
                        header={<React.Fragment>
                            <div
                                ...
                                <div
                                    ...
                                    <div className="d-flex align-items-center">
                                        <img alt={""} src={Images.line_item_icon_green} className="img-fluid mr-2"/>
                                        {/*{newPricing?.resource_type === "INVENTORY_KIT" || newPricing?.resource_type === "INVENTORY_ITEM" ? newPricing?.resource_id?.name`${newPricing?.variant?.line_item?.name} ${foundRegion && '/'} ${foundRegion?.title || ""} - ${newPricing.variant?.name}`}*/}
                                    </div>
                                    {/*{!removeThreeDots &&*
                    ...
                    <div
                      className="custom-table-cell-td p-0 gray-2-color"
                      // onClick={this.stopEvtBubbling}
                    >
                      {/*{newPricing?.manually_added ? (
                        newPricing?.type === "INVENTORY_ITEM" ? (
                        ...
                        <>
...

                          {
                            this.state.pricingUom?.length <= 1 ?
                              ...
                              <Select
                                dropdownClassName="border-green"
                                className="edit-select-box edit-box-custom w-100"
                                suffixIcon={<CaretDownOutlined />}
                                // defaultValue="b"
...
export default WOServiceVariantsDetails