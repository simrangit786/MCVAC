...
import WOSiteManagerAccountDetails from "./WOSiteManagerAccountDetails";
import { getSiteOwnerContacts } from "../../../../Controller/api/workOrderServices";
import { userTypes } from "../../../../Controller/userTypes";
import { handleError } from '../../../../Controller/Global';

const {Panel} = Collapse;

class WOSiteManagerAccountView extends Component {
    state = {
      data: [],
    };
    ...
    render() {
        ...
        return (
                        ...
                        >
                            ...
                            >
                                <Panel
                                    ...
                                    forceRender
                                >
                                    <WOSiteManagerAccountDetails data={item}/>
                                </Panel>
                            </Collapse>
                        </div>
                        ))}
            ...
            <div
              className={`col-12 ${
                !this.props.viewAll ? "no-data-card-row-new" : ""
              }`}
            >
...
export default WOSiteManagerAccountView;
