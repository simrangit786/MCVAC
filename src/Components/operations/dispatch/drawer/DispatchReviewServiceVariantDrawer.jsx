...
class DispatchReviewServiceVariantDrawer extends Component {
  state = {
    crewChief: "",
    employees: [],
    search: "",
          ...
          <div className="row mx-0 inner-modal-main-row">
            <div className="col-12">
              <div className="row mx-0 dispatch-word-card position-relative pb-0">
                <div className={"status-btn"}>{workOrder?.workorder?.status}</div>
                <div className="col-12 position-relative dispatch-card-heading">
                  <h6>
                    <div className="work-id">{workOrder?.workorder?.id}</div>
                    <div className="project-name">
                      {workOrder?.workorder?.project?.name}
                    </div>
                  </h6>
                </div>
                <div className="col-12">
                  <ul className="list-inline  ">
                    <li className="pl-0 text-left">
                      <img
                        ...
                        className="img-fluid"
                      />
                      {moment(workOrder?.workorder?.service_date).format(
                            "MMM D ,YYYY"
                          )}{" "}
                      {/* {workOrder?.workorders?.length > 0 && workOrder?.workorders[0]?.workorder?.service_date
                        ...
                        : "-"}{" "} */}
                      |{" "}
                      {moment(workOrder?.workorder?.start_time, "HH:mm").format("HH:mm A")}{" "}
                        ...
                        <div className="row mx-0 align-items-center">
                          ...
                          >
                            <div className="user-icons-div">
                              <span className="text-uppercase user-name-tg">
                                {workOrder.crew_chief.split(" ")[0].split("")[0]}{workOrder.crew_chief.split(" ")[1].split("")[0]}
                              </span>
                            </div>
                            <div className="user-info-div pt-0">
                              <h6>{workOrder?.crew_chief}</h6>
                            </div>
                          </div>
                          <div
                            style={{ width: "20%" }}
                ...
                <div className="col-12 table-responsive main-table-div position-relative wage-table">
                  <div className="row mx-0 custom-table-main-row custom-table-main-row-proposal-line-item custom-table-main-row-wage-info-main proposal-update-table dispatch-service-varient">
                    ...
                    <div className="row mx-0 w-100">
                      {workOrder?.workorder?.workorder_variant && workOrder?.workorder?.workorder_variant?.map((n) => {
                        return (
...
export default DispatchReviewServiceVariantDrawer;
