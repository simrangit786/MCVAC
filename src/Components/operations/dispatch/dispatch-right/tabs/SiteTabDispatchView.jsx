...
class SiteTabDispatchView extends Component {
    render() {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 px-0 data-header-employees">
                                        <div style={{
                                            ...
                                            <h6 className="mb-0 small-heading-div">Site (13)</h6>
                                        </div>
                                        <div style={{
                                            minHeight: '70px',
                                            borderTop:'1px solid #e0e0e0'
                                            ...
                                            <div className="card-box-header-2">
                                                <div className="card-operator">
                                                    ...
                                                    {/*<div className="row mx-0 no-data-card">
                                                        <h6 className="mb-0">No Laborers</h6>
                                                    </div>*/}
                                                    <div className="row mx-0 operator-card-main">
                                                        <div className="col-12 d-flex align-items-center">
                                                            <div className="operator-initial">
                                                                <img alt={' '} className="img-fluid" src={Images.location_green_icon}/>
                                                            </div>
                                                            <div className="operator-details">
                                                                <h6 className="mb-0">Site Name / Address</h6>
                                                                <p className='mb-0'>123 W 112TH ST New Yo...</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
export default SiteTabDispatchView;