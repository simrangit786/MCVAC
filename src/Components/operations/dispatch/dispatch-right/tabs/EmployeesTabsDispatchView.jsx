...
class EmployeesTabsDispatchView extends Component {
    render() {
                                ...
                                <div className="row">
                                    <div className="col-12 px-0 data-header-employees">
                                        ...
                                        <div style={{
                                            ...
                                            <h6 className="mb-0">Employees (15)</h6>
                                        </div>
                                    </div>
                                    <div className="col-12 px-0 data-header-employees">
                                        <div style={{
                                            ...
                                            <h6 className="mb-0 small-heading-div">Employees (8)</h6>
                                        </div>
                                        <div style={{
                                            minHeight: '70px',
                                            borderTop:'1px solid #e0e0e0'
...
export default EmployeesTabsDispatchView;