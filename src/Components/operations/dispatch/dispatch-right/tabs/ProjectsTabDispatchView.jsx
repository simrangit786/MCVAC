...
class ProjectsTabDispatchView extends Component {
    render() {
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 px-0 data-header-employees">
                                        <div style={{
                                            ...
                                            <h6 className="mb-0 small-heading-div">Project (8)</h6>
                                        </div>
                                        <div style={{
                                            minHeight: '70px',
                                            borderTop:'1px solid #e0e0e0'
                                                    ...
                                                    <div className="row mx-0 operator-card-main">
                                                        <div className="col-12 d-flex align-items-center">
                                                            <div className="operator-initial">
                                                                <img alt={' '} className="img-fluid" src={Images.folder_green}/>
                                                            </div>
...
export default ProjectsTabDispatchView;