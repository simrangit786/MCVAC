...
class CreateVehiclePackages extends Component {
  state = {
    visible: false,
    editData: null,
    packageData: null,
  ...
  handlePackageName = () => {
    ...
    if (this.state.packageData) {
      updateFleetFamily(this.state.packageData.id, data)
        .then((res) => {
                        ...
                        <div className="col-10">
                          <div className="row mx-0 h-100 icon-info-details align-items-center">
                            <small className="small-text-main">
                              ...
                              become{" "}
                              <b className="text-black-50">Fleet Groups</b> in
                              the next step.
                            </small>
                          </div>
                        </div>
                                ...
                                <div className="d-flex align-items-center">
                                  <div className="branch-icon-text d-flex align-items-center">
                                    <img
                                      src={
                                        data.type === "parent"
                                          ? Images.vehicle_package
                                          : data.children.filter(
                                              (item) => !item.type
                                            ).length > 0
                                          ? null
                                          : Images.vehicle_group
                                      }
                                      alt={""}
                                      className="img-fluid"
                                    />
...
export default withRouter(CreateVehiclePackages);
