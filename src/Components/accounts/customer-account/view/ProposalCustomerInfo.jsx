...
const ProposalCustomerInfo = props => {
   ...
   const fetchProposal = (params = {}) => {
        setLoading(true);
        getProposals({customer_account : props.customer ? props.customer.id : props.match.params.id, ...params })
          .then((res) => {
      ...
      const onSearch = (e) => {
        setSearch({...search,search:e.target.value,page:1})
      };
...
export default withRouter(ProposalCustomerInfo);