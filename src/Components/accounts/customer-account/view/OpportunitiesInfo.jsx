...
import { Button, Empty, Form, Input, message, Table } from "antd";
...
class OpportunitiesInfo extends Component {
  ...
  fetchOpportunity = (params = {}) => {
    ...
    getOpportunities({ customer_account: this.props.customer ? this.props.customer.id : this.props.match.params.id, ...params })
      .then((res) => {
          ...
          {opportunities.length > 0 ? (
            <div className="col-12 table-responsive width-160-id main-table-div">
              <Table
                ...
                //                    <h6 className="mb-0 approved-btn" style={{color:"#38bc94"}}>Add Opportunity</h6>
                //                </div>
                //            </div>
                //        </div>
                //    }}
                ...
                onClick={console.log(opportunities.id)}
                size="middle"
