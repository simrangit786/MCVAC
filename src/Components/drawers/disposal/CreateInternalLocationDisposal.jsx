...
import CommonConfirmationModal from "../../../Components/modals/CommonConfirmationModal";
...
class CreateInternalLocationDisposal extends Component {
  state = {
    data: null,
    buttonLoading: false,
              ...
              >
                <div className="row">
                  ...
                  <div className="col-12">
                    ...
                    >
                      <InputNumber placeholder={"123-456-7890"} />
                    </Form.Item>
                  </div>
                  <div className="col-12">
                    <Form.Item
...
export default withRouter(CreateInternalLocationDisposal);
